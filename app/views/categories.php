        ...
        <div class="content">
            ...
            <div class="table-container">
                <table>
                    ...
                    <form action="<?php echo URLROOT ?>/categories/edit" method="post" enctype="multipart/form-data">
                    <tr>
                    <td>
                    <input type="hidden"  id="id" name="id" value="<?=$row['id']?>">
                    <label id="labelname<?=$i?>"><?= $row['title'] ?></label>
                    <input type="text" class="text" name="nameT" id="nomT<?=$i?>" value="<?= $row['title'] ?>" style="display:none">
                    </td>
                    <td class="text-center">
                   
                    <label id="labelimg<?=$i?>"><img src="<?php echo IMAGE."icons/".$row['img']?>" alt=""></label>
